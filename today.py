...
USER_NAME = os.environ['USER_NAME'] # 'GitGudScrubss'
...
if __name__ == '__main__':
    ...
    # e.g. {'id': '...'} and an ISO 8601 creation timestamp for USER_NAME
    user_data, user_time = perf_counter(user_getter, USER_NAME)
    OWNER_ID, acc_date = user_data
    formatter('account data', user_time)
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2005, 12, 17))
